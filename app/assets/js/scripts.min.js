...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    a.Controller = function(d) {
        var f, g, h = "ScrollMagic.Controller", i = {
            f: "FORWARD",
            r: "REVERSE",
            p: "PAUSED"
        }, j = c.defaults, k = this, l = e.extend({}, j, d), m = [], n = !1, o = 0, p = i.p, q = !0, r = 0, s = !0, t = function() {
            for (var b in l) j.hasOwnProperty(b) || (C(2, 'WARNING: Unknown option "' + b + '"'), 
            delete l[b]);
            if (l.container = e.get.elements(l.container)[0], !l.container) throw C(1, "ERROR creating object " + h + ": No valid scroll container supplied"), 
            h + " init failed.";
            q = l.container === window || l.container === document.body || !document.body.contains(l.container), 
            q && (l.container = window), r = w(), l.container.addEventListener("resize", A), 
            l.container.addEventListener("scroll", A), l.refreshInterval = parseInt(l.refreshInterval) || j.refreshInterval, 
            u(), C(3, "added new " + h + " controller (v" + a.version + ")");
        }, u = function() {
            ...
            if (s && n) {
                ...
                o = k.scrollPos();
                var c = o - b;
                0 !== c && (p = c > 0 ? i.f : i.r), p === i.r && a.reverse(), a.forEach(function(b, c) {
                    C(3, "updating Scene " + (c + 1) + "/" + a.length + " (" + m.length + " total)"), 
                    b.update(!0);
                }), 0 === a.length && l.loglevel >= 3 && C(3, "updating 0 Scenes (nothing added to controller)");
            }
        }, z = function() {
            f = e.rAF(y);
        }, A = function(a) {
            C(3, "event fired causing an update:", a.type), "resize" == a.type && (r = w(), 
            p = i.p), n !== !0 && (n = !0, z());
        }, B = function() {
            if (!q && r != w()) {
                var a;
        ...
        }, C = this._log = function(a, b) {
            l.loglevel >= a && (Array.prototype.splice.call(arguments, 1, 0, "(" + h + ") ->"), 
        ...
        return this.addScene = function(b) {
            if (e.type.Array(b)) b.forEach(function(a, b) {
                ...
                if (b.controller() !== k) b.addTo(k); else if (m.indexOf(b) < 0) {
                    m.push(b), m = D(m), b.on("shift.controller_sort", function() {
                        m = D(m);
                    });
                    for (var c in l.globalSceneOptions) b[c] && b[c].call(b, l.globalSceneOptions[c]);
                    C(3, "adding Scene (now " + m.length + " total)");
                }
            ...
            if (e.type.Array(a)) a.forEach(function(a, b) {
                ...
                var b = m.indexOf(a);
                b > -1 && (a.off("shift.controller_sort"), m.splice(b, 1), C(3, "removing Scene (now " + m.length + " left)"), 
                a.remove());
            }
            return k;
            ...
            return e.type.Array(b) ? b.forEach(function(a, b) {
                k.updateScene(a, c);
            }) : c ? b.update(!0) : n !== !0 && b instanceof a.Scene && (n = n || [], -1 == n.indexOf(b) && n.push(b), 
            n = D(n), z()), k;
            ...
            if (e.type.Number(c)) x.call(l.container, c, d); else if (c instanceof a.Scene) c.controller() === k ? k.scrollTo(c.scrollOffset(), d) : C(2, "scrollTo(): The supplied scene does not belong to this controller. Scroll cancelled.", c); else if (e.type.Function(c)) x = c; else {
                var f = e.get.elements(c)[0];
                if (f) {
                    for (;f.parentNode.hasAttribute(b); ) f = f.parentNode;
                    var g = l.vertical ? "top" : "left", h = e.get.offset(l.container), i = e.get.offset(f);
                    q || (h[g] -= k.scrollPos()), k.scrollTo(i[g] - h[g], d);
                } else C(2, "scrollTo(): The supplied argument is invalid. Scroll cancelled.", c);
            }
            return k;
        }, this.scrollPos = function(a) {
            return arguments.length ? (e.type.Function(a) ? v = a : C(2, "Provided value for method 'scrollPos' is not a function. To change the current scroll position use 'scrollTo()'."), 
            k) : v.call(k);
            ...
            return arguments.length ? void 0 !== b[a] ? b[a] : void C(1, 'ERROR: option "' + a + '" is not available') : b;
            ...
            return l.container.removeEventListener("resize", A), l.container.removeEventListener("scroll", A), 
            e.cAF(f), C(3, "destroyed " + h + " (reset: " + (a ? "true" : "false") + ")"), null;
        }, t(), k;
    };
    var c = {
        defaults: {
    ...
    a.Controller.addOption = function(a, b) {
        ...
        var f, g, h = "ScrollMagic.Scene", i = d.defaults, j = this, k = e.extend({}, i, c), l = "BEFORE", m = 0, n = {
            start: 0,
            end: 0
        }, o = 0, p = !0, q = function() {
        ...
        }, r = this._log = function(a, b) {
            k.loglevel >= a && (Array.prototype.splice.call(arguments, 1, 0, "(" + h + ") ->"), 
            e.log.apply(window, arguments));
        };
        this.addTo = function(b) {
            return b instanceof a.Controller ? g != b && (g && g.removeScene(j), g = b, x(), 
            t(!0), u(!0), s(), g.info("container").addEventListener("resize", v), b.addScene(j), 
            j.trigger("add", {
                controller: g
            }), r(3, "added " + h + " to controller"), j.update()) : r(1, "ERROR: supplied argument of 'addTo()' is not a valid ScrollMagic Controller"), 
            j;
        }, this.enabled = function(a) {
            return arguments.length ? (p != a && (p = !!a, j.update(!0)), j) : p;
        }, this.remove = function() {
            if (g) {
                g.info("container").removeEventListener("resize", v);
                var a = g;
                g = void 0, a.removeScene(j), j.trigger("remove"), r(3, "removed " + h + " from controller");
            }
            return j;
        }, this.destroy = function(a) {
            return j.trigger("destroy", {
                reset: a
            }), j.remove(), j.off("*.*"), r(3, "destroyed " + h + " (reset: " + (a ? "true" : "false") + ")"), 
            null;
        }, this.update = function(a) {
            if (g) if (a) if (g.enabled() && p) {
            ...
            } else B && "DURING" === l && D(!0); else g.updateScene(j, !1);
            return j;
        }, this.refresh = function() {
            return t(), u(), j;
        }, this.progress = function(a) {
            if (arguments.length) {
                var b = !1, c = l, d = g ? g.info("scrollDirection") : "PAUSED", e = k.reverse || a >= m;
        ...
        var s = function() {
            n = {
                start: o + k.offset
            }, g && k.triggerElement && (n.start -= g.info("size") * k.triggerHook), n.end = n.start + k.duration;
        }, t = function(a) {
            if (f) {
                var b = "duration";
                y(b, f.call(j)) && !a && (j.trigger("change", {
                    what: b,
                    newval: k[b]
                }), j.trigger("shift", {
                    reason: b
            ...
            if (g && d) {
                ...
                f.isDocument || (h[i] -= g.scrollPos()), c = l[i] - h[i];
            }
            var m = c != o;
            o = c, m && !a && j.trigger("shift", {
            ...
            duration: function(a) {
                ...
                if (a = parseFloat(a), !e.type.Number(a) || 0 > a) throw f ? (f = void 0, [ 'Invalid return value of supplied function for option "duration":', a ]) : [ 'Invalid value for option "duration":', a ];
                return a;
            }
        }), x = function(a) {
            a = arguments.length ? [ a ] : Object.keys(w), a.forEach(function(a, b) {
                var c;
                if (w[a]) try {
                    c = w[a](k[a]);
                } catch (d) {
                    c = i[a];
                    var f = e.type.String(d) ? [ d ] : d;
                    e.type.Array(f) ? (f[0] = "ERROR: " + f[0], f.unshift(1), r.apply(this, f)) : r(1, "ERROR: Problem executing validation callback for option '" + a + "':", d.message);
                } finally {
                    k[a] = c;
                }
            });
            ...
            j[a] || (j[a] = function(b) {
                return arguments.length ? ("duration" === a && (f = void 0), y(a, b) && (j.trigger("change", {
                    what: a,
                    newval: k[a]
                }), d.shifts.indexOf(a) > -1 && j.trigger("shift", {
                    reason: a
                })), j) : k[a];
            });
        };
        this.controller = function() {
            ...
            var a = k.offset;
            return g && (a += k.triggerElement ? o : g.info("size") * j.triggerHook()), a;
        };
        var A = {};
        this.on = function(a, b) {
            ...
            return a ? (a = a.trim().split(" "), a.forEach(function(a, c) {
                var d = a.split("."), e = d[0], f = d[1] || "", g = "*" === e ? Object.keys(A) : [ e ];
            ...
            if (b) {
                ...
                r(3, "event fired:", e, c ? "->" : "", c || ""), g && g.forEach(function(b, d) {
        ...
        var D = function(a) {
            if (B && g) {
                ...
                if (a || "DURING" !== l) {
                    var c = {
                        ...
                        top: 0,
                        left: 0
                    }, d = e.css(B, "position") != c.position;
                    C.pushFollowers ? k.duration > 0 && ("AFTER" === l && 0 === parseFloat(e.css(C.spacer, "padding-top")) ? d = !0 : "BEFORE" === l && 0 === parseFloat(e.css(C.spacer, "padding-bottom")) && (d = !0)) : c[b.vertical ? "top" : "left"] = k.duration * m, 
                    e.css(B, c), d && E();
                } else {
                    "fixed" != e.css(B, "position") && (e.css(B, {
                        position: "fixed"
                    }), E());
                    var f = e.get.offset(C.spacer, !0), h = k.reverse || 0 === k.duration ? b.scrollPos - n.start : Math.round(m * k.duration * 10) / 10;
                    f[b.vertical ? "top" : "left"] += h, e.css(B, {
                        top: f.top,
                        left: f.left
                    });
                }
            ...
            if (B && g && C.inFlow) {
                var a = "DURING" === l, b = g.info("vertical"), c = C.spacer.children[0], d = e.isMarginCollapseType(e.css(C.spacer, "display")), f = {};
                C.relSize.width || C.relSize.autoFullWidth ? a ? e.css(B, {
                    width: e.get.width(C.spacer)
                }) : e.css(B, {
                    width: "100%"
                }) : (f["min-width"] = e.get.width(b ? B : c, !0, !0), f.width = a ? f["min-width"] : "auto"), 
                C.relSize.height ? a ? e.css(B, {
                    height: e.get.height(C.spacer) - (C.pushFollowers ? k.duration : 0)
                }) : e.css(B, {
                    height: "100%"
                }) : (f["min-height"] = e.get.height(b ? c : B, !0, !d), f.height = a ? f["min-height"] : "auto"), 
                C.pushFollowers && (f["padding" + (b ? "Top" : "Left")] = k.duration * m, f["padding" + (b ? "Bottom" : "Right")] = k.duration * (1 - m)), 
                e.css(C.spacer, f);
            }
        }, F = function() {
            g && B && "DURING" === l && !g.info("isDocument") && D();
        }, G = function() {
            g && B && "DURING" === l && ((C.relSize.width || C.relSize.autoFullWidth) && e.get.width(window) != e.get.width(C.spacer.parentNode) || C.relSize.height && e.get.height(window) != e.get.height(C.spacer.parentNode)) && E();
        }, H = function(a) {
            g && B && "DURING" === l && !g.info("isDocument") && (a.preventDefault(), g._setScrollPos(g.info("scrollPos") - ((a.wheelDelta || a[g.info("vertical") ? "wheelDeltaY" : "wheelDeltaX"]) / 3 || 30 * -a.detail)));
        };
        this.setPin = function(a, c) {
            ...
            if (c = e.extend({}, d, c), a = e.get.elements(a)[0], !a) return r(1, "ERROR calling method 'setPin()': Invalid pin element supplied."), 
            j;
            if ("fixed" === e.css(a, "position")) return r(1, "ERROR calling method 'setPin()': Pin does not work with elements that are positioned 'fixed'."), 
            j;
            if (B) {
                if (B === a) return j;
                j.removePin();
            ...
            B = a;
            var f = B.parentNode.style.display, g = [ "top", "left", "bottom", "right", "margin", "marginLeft", "marginRight", "marginTop", "marginBottom" ];
            B.parentNode.style.display = "none";
            var h = "absolute" != e.css(B, "position"), i = e.css(B, g.concat([ "display" ])), l = e.css(B, [ "width", "height" ]);
            B.parentNode.style.display = f, !h && c.pushFollowers && (r(2, "WARNING: If the pinned element is positioned absolutely pushFollowers will be disabled."), 
            c.pushFollowers = !1), window.setTimeout(function() {
                B && 0 === k.duration && c.pushFollowers && r(2, "WARNING: pushFollowers =", !0, "has no effect, when scene duration is 0.");
            }, 0);
            var m = B.parentNode.insertBefore(document.createElement("div"), B), n = e.extend(i, {
                position: h ? "relative" : "absolute",
                boxSizing: "content-box",
                mozBoxSizing: "content-box",
                webkitBoxSizing: "content-box"
            });
            if (h || e.extend(n, e.css(B, [ "width", "height" ])), e.css(m, n), m.setAttribute(b, ""), 
            e.addClass(m, c.spacerClass), C = {
                spacer: m,
                relSize: {
                    width: "%" === l.width.slice(-1),
                    height: "%" === l.height.slice(-1),
                    autoFullWidth: "auto" === l.width && h && e.isMarginCollapseType(i.display)
                },
                pushFollowers: c.pushFollowers,
                inFlow: h
            }, !B.___origStyle) {
                B.___origStyle = {};
                var o = B.style, p = g.concat([ "width", "height", "position", "boxSizing", "mozBoxSizing", "webkitBoxSizing" ]);
                p.forEach(function(a) {
                    B.___origStyle[a] = o[a] || "";
                });
            }
            return C.relSize.width && e.css(m, {
                width: l.width
            }), C.relSize.height && e.css(m, {
                height: l.height
            }), m.appendChild(B), e.css(B, {
                position: h ? "relative" : "absolute",
                margin: "auto",
                top: "auto",
                left: "auto",
                bottom: "auto",
                right: "auto"
            }), (C.relSize.width || C.relSize.autoFullWidth) && e.css(B, {
            ...
            if (B) {
                if ("DURING" === l && D(!0), a || !g) {
                    var c = C.spacer.children[0];
                    if (c.hasAttribute(b)) {
                        var d = C.spacer.style, f = [ "margin", "marginLeft", "marginRight", "marginTop", "marginBottom" ];
                        margins = {}, f.forEach(function(a) {
                            margins[a] = d[a] || "";
                        }), e.css(c, margins);
                    }
                    C.spacer.parentNode.insertBefore(c, C.spacer), C.spacer.parentNode.removeChild(C.spacer), 
                    B.parentNode.hasAttribute(b) || (e.css(B, B.___origStyle), delete B.___origStyle);
                }
        ...
        return j.on("destroy.internal", function(a) {
            ...
            return 0 !== c.length && e.type.String(b) ? (J.length > 0 && j.removeClassToggle(), 
            ...
            return a && J.forEach(function(a, b) {
                e.removeClass(a, I);
    ...
    var d = {
        ...
        validate: {
            ...
            loglevel: function(a) {
                if (a = parseInt(a), !e.type.Number(a) || 0 > a || a > 3) throw [ 'Invalid value for option "loglevel":', a ];
                return a;
            }
        },
    ...
    a.Scene.addOption = function(b, c, e, f) {
        b in d.defaults ? a._util.log(1, "[static] ScrollMagic.Scene -> Cannot add Scene option '" + b + "', because it already exists.") : (d.defaults[b] = c, 
        d.validate[b] = e, f && d.shifts.push(b));
