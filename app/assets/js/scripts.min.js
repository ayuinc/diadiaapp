...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TweenMax", [ "core.Animation", "core.SimpleTimeline", "TweenLite" ], function(a, b, c) {
        ...
        var ua, va = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), wa = V("transform"), xa = T + "transform", ya = V("transformOrigin"), za = null !== V("perspective"), Aa = O.Transform = function() {
            ...
            return c && (a._gsTransform = q, q.svg && (ua && a.style[wa] ? La(a.style, wa) : !ua && a.getAttribute("transform") && a.removeAttribute("transform"))), 
            q;
        }, Ha = function(a) {
            ...
            if (!(1 !== a && 0 !== a && x.force3D || x.force3D === !0 || x.rotationY || x.rotationX || 1 !== C || G || F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime)) return void Ja.call(this, a);
            ...
            u += D + v + E + v + F + v + (G ? 1 + -F / G : 1) + ")", y[wa] = u;
        }, Ja = O.set2DTransformRatio = function(a) {
            var b, c, d, e, f, g, h, i, j, k, l, m, n = this.data, o = this.t, p = o.style, q = n.x, r = n.y;
            return !(n.rotationX || n.rotationY || n.z || n.force3D === !0 || "auto" === n.force3D && 1 !== a && 0 !== a) || n.svg && ua || !za ? (e = n.scaleX, 
            ...
            n.svg && ua ? o.setAttribute("transform", "matrix(" + k) : p[wa] = (n.xPercent || n.yPercent ? "translate(" + n.xPercent + "%," + n.yPercent + "%) matrix(" : "matrix(") + k) : p[wa] = (n.xPercent || n.yPercent ? "translate(" + n.xPercent + "%," + n.yPercent + "%) matrix(" : "matrix(") + e + ",0,0," + f + "," + q + "," + r + ")")) : (this.setRatio = Ia, 
            void Ia.call(this, a));
        };
        ...
        sa("opacity,alpha,autoAlpha", {
            ...
            parser: function(a, b, c, d, f, g) {
                ...
                f.data = a, f.plugin = g, f.setRatio = Ka), j && (f = new oa(i, "visibility", 0, 0, f, -1, null, !1, 0, 0 !== h ? "inherit" : "hidden", 0 === b ? "hidden" : "inherit"), 
        ...
        var La = function(a, b) {
            ...
            if (this.t._gsClassPT = this, 1 === a || 0 === a) {
                ...
                for (var b = this.data, c = this.t.style; b; ) b.v ? c[b.p] = b.v : La(c, b.p), 
                b = b._next;
        ...
        sa("className", {
            parser: function(a, b, d, f, g, h, i) {
                ...
                if (g = f._classNamePT = new oa(a, d, 0, 0, g, 2), g.setRatio = Ma, g.pr = -11, 
        ...
        var Na = function(a) {
            if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                d = b.length; --d > -1; ) c = b[d], i[c] && (i[c].parse === g ? e = !0 : c = "transformOrigin" === c ? ya : i[c].p), 
                La(f, c);
        ...
        for (sa("clearProps", {
            parser: function(a, b, d, e, f) {
                return f = new oa(a, d, 0, 0, f, 2), f.setRatio = Na, f.e = b, f.pr = -10, f.data = e._tween, 
                c = !0, f;
            }
        ...
        j = g.prototype, j._firstPT = j._lastParsedTransform = j._transform = null, j._onInitTween = function(a, b, h) {
            ...
            this._transformType) {
                for (u = 3 === this._transformType, wa ? m && (l = !0, "" === v.zIndex && (s = X(a, "zIndex", e), 
                ...
                t = new oa(a, "transform", 0, 0, null, 2), this._linkCSSP(t, null, n), t.setRatio = u && za ? Ia : wa ? Ja : Ha, 
                t.data = this._transform || Ga(a, e, !0), t.tween = h, f.pop();
            }
            if (c) {
                for (;j; ) {
        ...
        var Pa = function(a, b, c) {
            var d, e, f, g;
            if (a.slice) for (e = a.length; --e > -1; ) Pa(a[e], b, c); else for (d = a.childNodes, 
            e = d.length; --e > -1; ) f = d[e], g = f.type, f.style && (b.push($(f)), c && c.push(f)), 
            1 !== g && 9 !== g && 11 !== g || !f.childNodes.length || Pa(f, b, c);
        };
        return g.cascadeTo = function(a, c, d) {
            var e, f, g, h, i = b.to(a, c, d), j = [ i ], k = [], l = [], m = [], n = b._internals.reservedProps;
            for (a = i._targets || i.target, Pa(a, k, m), i.render(c, !0, !0), Pa(a, l), i.render(0, !0, !0), 
